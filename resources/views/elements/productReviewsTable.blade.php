...
<script>
    ...
    function buildOneItem(item){
        ...
        {{--        <td>--}}
        {{--        <button type="button" class="q-btn-all q-color-alert waves-effect" onclick="showDeleteMessage('${item.id}', '{{ url("foodreviewsdelete") }}')">--}}
    ...
    function initTableHeader(){
        var html = `
            ...
            <th>{{$lang->get(549)}} <img <img onclick="tableHeaderSort('food');" src="${utilGetImg('food')}" class="img-fluid" style="margin-left: 10px; width: 20px; float: right;"></th> {{--Product--}}
